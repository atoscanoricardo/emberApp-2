    ...
    <v-card max-width="500" class="mx-auto">
      ...
      <v-card-text>
        ...
        <p class="font-weight-regular">
          Seleccione los Animales Embera o Inglés
        </p>
        <v-card class="mx-auto" max-width="500">
          <img
            :src="require('../assets/animales_act.jpeg')"
            width="340"
            :aspect-ratio="16 / 9"
          />
          <v-select
            ...
            :items="items"
            multiple
            label="Selecciona los animales en inglés o emberá"
            width="200"
            outlined
            dense
          ></v-select>
      ...
      <v-card-text>
        ...
        <p class="font-weight-regular">
          Seleccione la palabra correcta en Emberá o Inglés para cada imágen
        </p>
        ...
        >
          ...
          <v-expand-transition>
            <div v-show="shows[i].show">
              <v-divider></v-divider>
              <v-card-text>
                <b>Animal:</b> {{ shows[i].text_true }} <br /><b
                  >Significado:</b
                >
                {{ shows[i].val }}
              </v-card-text>
