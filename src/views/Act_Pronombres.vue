  ...
  <v-container grid-list-md>
    <v-card max-width="500" class="mx-auto">
      ...
      <v-card-text>
        ...
        <p class="font-weight-regular">Seleccione los pronombres Embera</p>
        <v-card class="mx-auto" max-width="500">
          <img
            :src="require('../assets/pron_act1.png')"
            width="340"
            :aspect-ratio="16 / 9"
          />
          <v-select
      ...
      <v-card-text>
        ...
        <p class="font-weight-regular">
          Seleccione el pronombre Embera para cada imágen
        </p>
        ...
        >
          ...
          <v-expand-transition>
            <div v-show="shows[i].show">
              <v-divider></v-divider>
              <v-card-text>
                <b>Pronombre:</b> {{ shows[i].text_true }} <br /><b
                  >Significado:</b
                >
                {{ shows[i].val }}
              </v-card-text>
...
export default {
  data: () => ({
    ...
    shows: [],
    selection: [],
    items: ["Kua", "Mu", "Zaa", "Bu", "Daira ", "Mara", "Biga"],
    correct: ["Mu", "Bu", "Daira ", "Mara"],
    resultAct1: "",
    cards: [
      {
        img: "el.png",
